...
export default function HomePage() {
  return (
    <section className="text-primary-background flex min-h-screen w-full flex-col items-center  justify-center">
      <article className="size-full border border-border p-6">
